...
This basic formula of adding a hyperlink to a photo will work for any photos in Markdown. If you are working with videos, however, there is a better option called an iframe<>. This format was created for embedding nicely-formatted videos into HTML pages, and allowing the user to play the video directly from the current page without having to go to YouTube.
