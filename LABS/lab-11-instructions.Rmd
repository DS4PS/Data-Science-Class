...
qmplot( Longitude, Latitude, data=d2, maptype="toner-lite", zoom=13, geom="blank" ) +
        geom_point( color="steelblue", size=0.7*point.size, alpha=0.2 ) +
...
This example demonstrates how to highlight accidents where fatalities occurred:
...
Similar to the leaflet example above, using a logical statement to identify all accidents involving pedastrians and cyclists. Highlight those cases with a bright color, and use some shade of gray for other accidents.
