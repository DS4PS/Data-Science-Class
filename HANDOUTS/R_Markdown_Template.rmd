...
Otherwise you will customize options directly in each chunk. 
...
Load all libraries required for analysis in this document. Note that you cannot install a package in RMarkdown documents, you can only load them.
