...
This dataset is located in GitHub:

```{r}
dat <- read.csv( "syr_parcels.csv", stringsAsFactors=F )
```


## About

This data set represents 42,000 tax parcels for the city of Syracuse, NY.

```{r, fig.cap="Syracuse Parcels", echo=F, fig.width=10 }
knitr::include_graphics( "syr_parcels/Syracuse_Parcels.png" )
```

```{r, fig.cap="Downtown Syracuse", echo=F, fig.width=6 }
