...
```{r, fig.cap="Membership defined by two sets", echo=F, fig.width=4, fig.height=4 }
knitr::include_graphics( "figures/xy.png" )
```

Operation      | Description
-------------- | -----------
union: X | Y          | The universe of all elements across all both sets: [A,B,C]
