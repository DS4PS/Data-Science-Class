...
Very loosely speaking a vector is a set of numbers or words. For example:

* Vector filled with numbers (numeric vector): **[ 1, 2, 3]** 

OR

* Vector of different fruit types:  **[ apple, orange, pear ]**

In social sciences, a vector is most typically used as a variable in a dataset.
